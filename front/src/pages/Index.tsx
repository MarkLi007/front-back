...
export default function Index() {
  const { isConnected, connectWallet, currentAccount } = useAuth();
  ...
  async function loadFeaturedNFTs() {
    try {
      ...
      // Get all NFT listings and take the first 3
  ...
  return (
    <Layout>
      ...
      <section className="mb-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-paper-primary">NFT版权市场</h2>
            <Link to="/nft-marketplace" className="text-paper-primary hover:text-paper-secondary flex items-center">
              浏览市场 <ChevronRight className="h-4 w-4 ml-1" />
            </Link>
          </div>
          ...
          {isLoadingNFTs ? (
            ...
            <div className="paper-card text-center p-8">
              ...
              <p className="text-gray-500 mb-4">市场上还没有NFT上架销售</p>
              <Button asChild>
                <Link to="/nft-marketplace">探索NFT市场</Link>
              </Button>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
