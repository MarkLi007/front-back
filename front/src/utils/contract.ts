...
// Complete ABI from the refactored contract
const abi = [
	{
		"inputs": [
			{
	...
	},
	{
		...
		"inputs": [
			...
			{
				"indexed": false,
				"internalType": "enum PaperRegistryRealistic.ReportType",
				"name": "reportType",
				"type": "uint8"
			},
			{
	...
	},
	{
		...
		"inputs": [
			...
			{
				"indexed": false,
				"internalType": "enum PaperRegistryRealistic.PaperStatus",
				"name": "finalStatus",
				"type": "uint8"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct PaperRegistryRealistic.VersionDetails",
				"name": "details",
				"type": "tuple"
			}
		],
...
// Updated contract address for the new contract
const contractAddress = "0xeD7bc61385Bd21837937774db04a5BCA469BEcc9";
...
export function mapReportTypeToString(reportType: number): string {
  switch (reportType) {
    case ReportType.FRAUD: return "学术造假";
    case ReportType.DUPLICATE: return "论文重复";
    case ReportType.INACCURACY: return "内容不准确";
    default: return "其他问题";
  }
}
